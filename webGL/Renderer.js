...
function RenderSkybox(mesh, shader) {
  var xRotationMatrix = new Float32Array(16);
  var yRotationMatrix = new Float32Array(16);
  var identityMatrix = new Float32Array(16);
  ...
  mat4.perspective(projMatrix, glMatrix.toRadian(45), canvas.width / canvas.height, 0.1, 100000000.0);
  ...
  mat4.mul(worldMatrix, yRotationMatrix, xRotationMatrix);
  mat4.translate(worldMatrix, worldMatrix, mesh.position);
  mat4.scale(worldMatrix, worldMatrix, [1000,1000,1000]);
